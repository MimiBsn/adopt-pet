...
const adviceList = [
  {
    ...
    answer:
      "If you're a tenant, it's essential to obtain approval from your landlord before introducing a pet into your rental property. Additionally, it's crucial to understand that even accommodations advertised as pet-friendly may impose limitations based on the type of pet, its weight, or breed. Furthermore, consider the duration of your lease and your long-term plans; if you relocate, you must ensure that your next residence also accommodates your pet.",
  },
  {
    id: 1,
    question: "2. It might be necessary to modify your timetable.",
    answer:
      "Diverse pets demand varying degrees of dedication and time, yet they all necessitate consistent attention and companionship, states Holly Sizemore, Chief Mission Officer at Best Friends Animal Society.",
  },
  {
    id: 2,
    question: "3. You'll always have company in the bathroom.",
    answer:
      "Your furry companion enjoys sleeping on the bed, joining you to watch your favorite shows, and offering companionship while you cook dinner. Therefore, it's common for them to want to be close to you even when you're attending to personal matters. ",
  },
  {
    id: 3,
    question: "4. Owning pets can incur significant costs",
    answer:
      "Some pet owners opt to purchase pet insurance to help cover unexpected veterinary costs. Pet insurance premiums vary depending on the coverage level and the pet's age, breed, and health.",
  },
  {
    id: 4,
  ...
  return (
    <>
      <h2 className="checklist">
        Checklist for Pet Adoption: 10 Factors to Ponder Before Bringing a Pet
        Home.
      </h2>

      <div className="image-container">
        <button className="prev" onClick={handleSliderPrev}>
          ▼
        </button>
        ...
        <img
          ...
          className="image"
        />
        <button className="next" onClick={handleSliderNext}>
          ▲
        </button>
      </div>
