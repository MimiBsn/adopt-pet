...
const UpdatePetForm = () => {
  ...
  useEffect(() => {
    const getUpdateProduct = async () => {
      ...
      setSex(updatedPet.data.sex);
      setSize(updatedPet.data.size);
      setPrimaryBreed(updatedPet.data.primary_breed);
      setPurebred(updatedPet.data.purebred);
      setPetAge(updatedPet.data.pet_age);
      setCountry(updatedPet.data.country);
      setCity(updatedPet.data.city);
      setActQuickly(updatedPet.data.act_quickly);
      setHairLength(updatedPet.data.hair_length);
      setSpecies(updatedPet.data.species);
